...
export const CerealCard: React.FC<CerealCardProps> = ({ cereal, onSelect, onAddToCart }) => {
    ...
    return (
        <motion.div
            ref={ref}
            className="relative w-full max-w-xs mx-auto cursor-pointer group [perspective:1000px]"
        ...
        >
            <motion.div
                ...
                className="relative bg-merlot-dark/50 backdrop-blur-sm border border-gold/20 rounded-xl p-3 shadow-2xl group-hover:shadow-[0_0_30px_rgba(212,175,55,0.2)]"
            ...
            >
                ...
                {/* Cereal Box Image */}
                <div
                    className="relative w-full max-w-[150px] mx-auto aspect-3/4 mb-3 transform-style-3d group-hover:translate-z-10 transition-transform duration-500 [transform:translateZ(20px)]"
                >
                    <img
                ...
                {/* Content */}
                <div className="text-center transform-style-3d [transform:translateZ(10px)]">
                    ...
                    <div className="flex justify-between items-center border-t border-white/10 pt-3 mt-2">
                        ...
                        <motion.button
                            ...
                            className="relative bg-linear-to-r from-gold to-gold-dim text-merlot px-3 py-2 rounded-lg font-bold text-xs overflow-hidden shadow-lg"
                                    ...
                                    <div key={key} className="space-y-1">
                                        ...
                                        <div className="h-1 bg-white/10 rounded-full overflow-hidden">
                                            <motion.div
                                                ...
                                                className="h-full bg-linear-to-r from-gold via-slime to-berry"
                                            />
                                        </div>
                                    </div>
                                ))}
