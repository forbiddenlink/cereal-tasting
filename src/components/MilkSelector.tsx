...
export const MilkSelector: React.FC<MilkSelectorProps> = ({ milks, selectedMilkId, onSelect }) => {
    return (
        <div className="glass-panel p-6 rounded-xl">
            <h3 className="text-xl font-heading text-gold mb-6 flex items-center gap-2">
                <span className="text-2xl">🥛</span> Select Your Solvent
            </h3>
            <div className="grid grid-cols-1 gap-4">
                {milks.map((milk) => (
                    <button
                        ...
                        className={`
                            group relative p-4 rounded-lg text-left transition-all duration-500 overflow-hidden
