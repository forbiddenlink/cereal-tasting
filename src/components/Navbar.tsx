    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 py-4 px-4 md:px-6 glass-panel-heavy">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                >
                    <motion.div
                        whileHover={{ rotate: 15, scale: 1.1, transition: springs.bouncy }}
                ...
                <div className="hidden md:flex items-center gap-6">
                    <button className="text-xs md:text-sm font-mono text-gold border-2 border-gold/40 px-3 py-1.5 md:px-4 md:py-2 rounded-full hover:bg-gold hover:text-merlot hover:border-gold transition-all duration-300 shadow-[0_0_10px_rgba(212,175,55,0.2)] hover:shadow-[0_0_20px_rgba(212,175,55,0.5)] hover:scale-105 font-bold\">
                        My Flight (0)
                    </button>
                </div>
            </div>
