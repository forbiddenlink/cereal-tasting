            ...
            <div className="container mx-auto max-w-6xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16">
                    ...
                    <motion.div
                        ...
                        className="glass-panel-heavy rounded-2xl border-2 border-gold/20 relative overflow-hidden group hover:border-gold/40 transition-all duration-500 p-12 mb-8"
                    >
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.6 }}
                    className="border-2 border-gold/30 rounded-2xl bg-gradient-to-br from-merlot/50 to-merlot-dark/50 relative overflow-hidden mb-16 p-12"
                >
