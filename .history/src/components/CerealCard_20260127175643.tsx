    ...
    return (
        ...
        >
            <motion.div
                ...
                className="relative bg-gradient-to-br from-merlot/80 to-void/90 backdrop-blur-sm border border-gold/20 rounded-xl p-4 shadow-2xl group-hover:shadow-[0_0_30px_rgba(212,175,55,0.2)] h-full flex flex-col"
            ...
            >
                ...
                <div className="text-center transform-style-3d transform-[translateZ(10px)] flex-1 flex flex-col">
                    <h3 className="text-lg font-heading text-gold mb-1 group-hover:text-cream transition-colors leading-tight tracking-wide">
                        {cereal.name}
                    </h3>
                    ...
                    <div className="flex justify-between items-center border-t border-gold/10 pt-3 mt-auto">
