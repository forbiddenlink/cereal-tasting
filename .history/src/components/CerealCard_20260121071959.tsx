    ...
    return (
        ...
        >
            <motion.div
                ...
                className="relative bg-merlot-dark/50 backdrop-blur-sm border border-gold/20 rounded-xl p-4 shadow-2xl transition-shadow duration-500 group-hover:shadow-[0_0_30px_rgba(212,175,55,0.2)]"
            >
                {/* Vintage Badge */}
                ...
                {/* Cereal Box Image */}
                <div
                    className="relative w-full max-w-[200px] mx-auto aspect-[3/4] mb-4 transform-style-3d group-hover:translate-z-10 transition-transform duration-500"
