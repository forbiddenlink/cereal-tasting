                ...
                <div className="text-center transform-style-3d [transform:translateZ(10px)]">
                    ...
                    <div className="flex justify-between items-center border-t border-white/10 pt-3 mt-2">
                        ...
                        <button 
                            ...
                            className="relative bg-linear-to-r from-gold to-gold-dim text-merlot px-3 py-2 rounded-lg font-bold text-xs hover:from-cream hover:to-gold transition-all duration-300 overflow-hidden shadow-lg hover:shadow-gold/50 hover:scale-105"
                        >
                            {addedToCart ? (
                                <motion.span
