    ...
    return (
        <>
            ...
            <motion.button
                ...
                className="fixed bottom-8 right-8 z-50 bg-gradient-to-br from-gold via-gold-dim to-gold text-merlot rounded-full p-4 shadow-2xl hover:shadow-[0_0_30px_rgba(212,175,55,0.6)] transition-shadow"
                        ...
                        >
                            <div className="p-6 space-y-6">
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className="w-full bg-gradient-to-r from-gold via-gold to-gold-dim text-merlot font-heading text-lg py-4 rounded-lg shadow-lg hover:shadow-[0_0_30px_rgba(212,175,55,0.4)] transition-shadow"
                                >
                                    Proceed to Checkout
                                </motion.button>
