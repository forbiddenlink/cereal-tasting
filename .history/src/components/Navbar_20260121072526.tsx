...
export const Navbar: React.FC<NavbarProps> = ({ onNavigate, currentPage }) => {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 py-4 px-4 md:px-6 glass-panel-heavy" style={{ backgroundColor: 'red' }}>
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center gap-6">
                    <button className="text-xs md:text-sm font-mono text-gold border border-gold/30 px-3 py-1.5 md:px-4 md:py-2 rounded-full hover:bg-gold hover:text-merlot transition-colors shadow-[0_0_10px_rgba(212,175,55,0.2)] hover:shadow-[0_0_20px_rgba(212,175,55,0.4)]">
                        My Flight (0)
                    </button>
                </div>
            </div>
