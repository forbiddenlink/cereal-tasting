        ...
        >
            ...
            >
                ...
                <div className="text-center transform-style-3d" style={{ transform: "translateZ(10px)" }}>
                    <h3 className="text-lg font-heading text-gold mb-1 group-hover:text-cream transition-colors">
                        {cereal.name}
                    </h3>
                    <p className="text-xs font-mono text-zinc-400 mb-3">{cereal.region}</p>

                    <div className="flex justify-center gap-2 mb-3">
                        {cereal.tastingNotes.slice(0, 2).map((note, i) => (
                            <span key={i} className="text-[10px] bg-white/5 border border-white/10 px-2 py-0.5 rounded-full text-cream/70">
                                {note}
                            </span>
                        ))}
                    </div>
                    ...
                    <div className="flex justify-between items-center border-t border-white/10 pt-3 mt-2">
                        ...
                        <button 
                            ...
                            className="relative bg-gold text-merlot px-3 py-1.5 rounded-md font-bold text-xs hover:bg-cream transition-colors overflow-hidden"
                        >
                            {addedToCart ? (
                                <motion.span
