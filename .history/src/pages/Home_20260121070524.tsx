...
export const Home: React.FC<HomeProps> = ({ onAddToCart }) => {
    ...
    return (style={{ scale: heroScale }}
            ...
            <motion.section
                ...
                className="relative z-10 -mt-40 mb-20"
            >
                <div className="container mx-auto px-4">
                    <div className="glass-panel-heavy rounded-2xl p-8 md:p-12">
            ...
            {/* Featured Collection */}
            <section className="container mx-auto px-4 relative z-10 mb-20g-clip-text text-transparent bg-gradient-to-r from-cream to-white">Distilled.</span>
                        </h1>
                    </motion.div>
